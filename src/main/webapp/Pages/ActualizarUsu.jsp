...
--%>
        <form action="EditarUsuarioServlet?action=actualizar" method="POST">
            ...
            value="<c:out value="${usuario.nombreUsuario}"></c:out>" type="text"
                               class="form-control" 
                               aria-label="Sizing exampleinput" 
                         aria-describedby="inputGroup-sizing-default" required>                    
                        <div id="usuarioname" 
                            class="form-text">Solo letras y numeros</div>
                    </div>
                    <div class="mb-3">
                          <span class="input-group-addon"><i class="fa fa-user">
                    ...
                    <div class="mb-3">
                        <span class="input-group-addon"><i class=
                                              "fa fa-hourglass-end"></i></span>
                        <label for="exampleInputEmail1" class="form-label">Edad
                        </label>
                        <input name="edad" 
                        value="<c:out value="${usuario.edad}"></c:out>" 
